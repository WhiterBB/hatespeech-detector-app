  ...
  return (
    <div className="mt-8">
      <div className="text-center">
        ...
        {hateSegments.length > 0 ? (
          <>
            <p className="text-lg mt-2">
              🟥 <strong>{(hateCoverage * 100).toFixed(1)}%</strong> of the
              video contains hate speech
            </p>
          ...
          <p className="text-green-500 text-lg mt-2 font-semibold">
            No hate speech was detected in this video.
          </p>
        )}
      </div>
